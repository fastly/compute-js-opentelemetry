...
| [Metrics Exporter for Fastly named log provider](./src/exporter-metrics-otlp-fastly-logger)                       | `@fastly/compute-js-opentelemetry/exporter-metrics-otlp-fastly-logger`                | A Metric Exporter implementation that exports metrics using the OTLP/HTTP JSON format over a Fastly named log provider.                                                                                                                                                                                                                                                                                                             |
