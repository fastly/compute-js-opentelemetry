 ...
 * @param contentType
 */
export async function sendWithFetch<ExportItem extends {}, ServiceRequest extends {}>(
 ...
 * @param data
 */
export function sendWithFastlyLogger<ExportItem extends {}, ServiceRequest extends {}>(
